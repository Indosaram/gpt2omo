...
pub struct Cli {
    ...
    #[arg(long, env = "OMO_BRIDGE_BIND", default_value = "127.0.0.1:18800")]
    pub bind: String,
    ...
    #[arg(long, env = "OMO_MAX_FILE_BYTES", default_value_t = 10 * 1024 * 1024)]
    pub max_file_bytes: usize,

    /// Maximum command timeout in milliseconds
    #[arg(long, env = "OMO_COMMAND_TIMEOUT_MS", default_value_t = 300_000)]
